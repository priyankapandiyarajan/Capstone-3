...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                ...
                quantity_tons_log = st.text_input("Enter Quantity Tons (Min:611728 & Max:1722207579)")
                thickness_log = st.text_input("Enter thickness (Min:0.18 & Max:400)")
            ...
            flag=0 
            pattern = "^(?:\d+|\d*\.\d+)$"
            for i in [quantity_tons_log,thickness_log,width,customer]:             
        ...
        if submit_button and flag==0:
            ...
            new_sample= np.array([[np.log(float(quantity_tons_log)),application,np.log(float(thickness_log)),float(width),
